        ...
        <main className="main">
          ...
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "1rem", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", flex: 1, gap: "0.6rem", alignItems: "center" }}>
              <button className="btn btn-sm hide-desktop" style={{ color: "var(--danger)", background: "transparent", border: "none", padding: "0 4px", display: "flex", alignItems: "center" }} onClick={() => supabase.auth.signOut()} title="Log Out">
